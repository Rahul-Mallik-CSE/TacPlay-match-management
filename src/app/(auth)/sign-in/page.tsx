    ...
    <AuthBanner>
      <div className="flex flex-col items-center">
        ...
        <div className="w-full space-y-5">
          ...
          {/* Sign In Button */}
          <button onClick={handleSignIn} className="w-full py-3 rounded-lg bg-custom-red text-white text-sm font-semibold hover:bg-custom-red/90 transition-colors border-2 border-border">
            Sign In
          </button>
          ...
          {/* Google Sign In */}
          <button className="w-full py-3 rounded-lg border border-white/10 bg-input/30 text-sm font-medium text-primary flex items-center justify-center gap-2 hover:bg-input/50 transition-colors">
